...
export default function ImageSlider({ url = "https://picsum.photos/v2/list", page = 1, limit = 10 }) {
  ...
  if (loading) return <div className='alertDisplays'>Loading images, please wait...</div>
  if (errorMsg) return <div className='alertDisplays'>An error occurred: {errorMsg}</div>
