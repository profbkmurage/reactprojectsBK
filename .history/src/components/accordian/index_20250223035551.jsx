            ...
            <div key={dataItem.id} className='item'>
              ...
              >
                ...
                <span>+</span>
                  ...
                  {
                      enableMultipleSelection? multipleSelection.indexOf(dataItem)!==-1&& ;<div className='content'>{dataItem.answer}</div> : selected === dataItem.id && ;<div className='content'>{dataItem.answer}</div>
