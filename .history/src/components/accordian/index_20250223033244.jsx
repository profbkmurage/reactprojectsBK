        ...
        {data && data.length > 0 ? (
          data.map(dataItem => (
            <div key={dataItem.id} className='item'>
              <div
                onClick={enableMultipleSelection? handleMultiSelection(dataItem.id() ) :() => handleSigleSelection(dataItem.id)} //we check to see if the multiselction mode is enabled and 
                className='title'
              >
